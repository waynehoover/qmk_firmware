...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [DVORAKIL] = LAYOUT(
    ...
    DV_COLN , DV_Q    , DV_J    , DV_K    , DV_X    ,         DV_B    , DV_L    , DV_W    , DV_V    , DV_Z     ,
                                  THB_L2  , THB_L1  ,         THB_R1  , THB_R2
  ),

  [LOWER] = LAYOUT(
    SW_APP  , SW_WIN  , DV_LCBR , DV_RCBR , _______ ,         FND_ALL , WD_LFT  , KC_UP   , WD_RHT  , _______  ,
    OS_ALT  , OS_CTRL , OS_SHFT , OS_CMD  , _______ ,         CW_TOGG , KC_LEFT , KC_DOWN , KC_RGHT , TOG_COMM ,
    _______ , SW_TAB  , DV_LBRC , DV_RBRC , _______ ,         _______ , LN_BEG  , DEL_WD  , LN_END  , DEL_LINE ,
