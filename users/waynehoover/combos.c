...
const uint16_t PROGMEM combo_12[] = {ALT_COLN, DV_Q, COMBO_END};     // quit
...
combo_t key_combos[] = {
    ...
    [CM_5]  = COMBO(combo_5, C(S(KC_TAB))),  // prev tab (Ctrl+Shift+Tab; works in browsers + herdr)
    [CM_6]  = COMBO(combo_6, C(KC_TAB)),     // next tab (Ctrl+Tab; works in browsers + herdr)
